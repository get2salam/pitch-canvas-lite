  ...
  "tagline": "Shape a persuasive pitch with problem, proof, offer, and close blocks.",
  "domainLabel": "blocks",
  "itemLabel": "block",
  "emptyTitle": "No pitch blocks yet",
  "emptyBody": "Sketch the problem, proof, product, and close.",
  "seedTitle": "Pitch backbone",
  "seedSubtitle": "A simple board for tightening your message before you hit send.",
  "categories": [
    "Problem",
    "Proof",
    "Offer",
  ...
  "items": [
    {
      ...
      "score": 10,
      "effort": 2,
      "note": "Lead with the cost of bad research workflow, not the software features."
    },
    {
      "title": "Show the proof artifact",
      "category": "Proof",
      "state": "Draft",
      "score": 8,
      "effort": 5,
      "note": "Use a live before-and-after screenshot or outcome table instead of abstract claims."
    },
    {
      "title": "One-line offer",
      "category": "Offer",
      "state": "Ready",
      "score": 9,
      "effort": 3,
      "note": "Package the transformation in one sentence the buyer could forward internally."
    }
  ]
};
